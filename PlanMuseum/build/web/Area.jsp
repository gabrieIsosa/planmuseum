...
<html>
    ...
    <body>
        ...
        <div class="contenedor">
            ...
            <caption><div><a href="AltaArea.jsp">Agregar Area</a></div></caption>
            <thead>
                <tr>
                    <th>ID_AREA</th>
                    <th>NOMBRE</th>
                ...
                %>
                <tr>
                    <td data-label="ID_AREA"><%= resultSet.getInt("id_area")%></td>
                    <td data-label="NOMBRE"><%= resultSet.getString("nombre_area")%></td>
                    <td data-label="ACCIONES">
                        <div><a href="EditarArea.jsp?idarea=<%= resultSet.getInt("id_area")%>">Editar</a></div>
                        <div><a href="EliminarArea.jsp?idarea=<%= resultSet.getInt("id_area")%>">Eliminar</a></div>
                    </td>
                </tr>
                <%}%>
                </tbody>
