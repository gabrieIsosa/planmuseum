...
<html>
    ...
    <body>
        <%
            ...
            resultSet=statement.executeQuery("SELECT imagen.ID_IMAGEN, museo.NOMBRE_MUSEO, imagen.NOMBRE_IMAGEN, imagen.RUTA_IMG, museo.ID_MUSEO from imagen inner join museo on imagen.ID_MUSEO=museo.ID_MUSEO");
        %>
        <header>
        ...
        <div class="contenedor">
            ...
            <caption><div><a href="AltaImagen.jsp">Agregar Imagen</a></div></caption>
            ...
            <tbody>
                ...
                %>
                <tr>
                    <td data-label="ID_IMAGEN" ><%= resultSet.getInt("id_imagen")%></td>
                    <td data-label="MUSEO" ><%= resultSet.getString("nombre_museo")%></td>
                    <td data-label="NOMBRE" ><%= resultSet.getString("nombre_imagen")%></td>
                    
                    <td style="visibility:collapse; display:none;"><%= resultSet.getString("id_museo")%></td>
                    <td data-label="ACCIONES" >
                        <div><a href="EditarImagen.jsp?idimg=<%= resultSet.getInt("id_imagen")%>&idmuseo=<%= resultSet.getInt("id_museo")%>">Editar</a></div>
                        <div><a href="EliminarImagen.jsp?idimg=<%= resultSet.getInt("id_imagen")%>&ruta=<%= resultSet.getString("ruta_img")%>">Eliminar</a> </div>                      
                    </td>
                </tr>
                <%}%>
                 </tbody>
