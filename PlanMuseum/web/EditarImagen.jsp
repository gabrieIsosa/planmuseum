    ...
    <body>
       ...
       <header>
        ...
        <div id="formulario">
            ...
            <form action="EditarImgServlet" method="POST" enctype="multipart/form-data">
                <div>
                <label for="ID">ID :</label>
                <input id="ID" type="text" readonly="" name="txtIdImg" required value="<%= resultSet.getInt("id_imagen")%>"/>
                </div>
                <div>
                ...
                <input id="imagen" type="file" name="file">
                </div>
                <input type="submit" value="Ingresar">
                <button onclick="location.href='Imagen.jsp'" type="button">Volver</button>
            </form>
        <%}%>
        </div>
    </body>
